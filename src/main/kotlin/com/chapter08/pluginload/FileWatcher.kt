...
class FileWatcher(
    ...
    private val onCreated: FileEventListener = EMPTY, // 文件创建监听
    private val onModified: FileEventListener = EMPTY, // 文件修改监听
    private val onDeleted: FileEventListener = EMPTY // 文件删除监听
) {
